...
gui.add(parameters, "count", 0, 100000)
    .step(100)
    .onFinishChange(generateGalaxy);
gui.add(parameters, "size", 0.001, 0.1)
    .step(0.001)
    .onFinishChange(generateGalaxy);
gui.add(parameters, "radius", 1, 20).step(1).onFinishChange(generateGalaxy);
gui.add(parameters, "branches", 2, 20).step(1).onFinishChange(generateGalaxy);
gui.add(parameters, "spin", -5, 5).step(0.02).onFinishChange(generateGalaxy);
gui.add(parameters, "randomness", 0, 2)
    .step(0.001)
    .onFinishChange(generateGalaxy);
gui.add(parameters, "randomnessPower", 1, 10)
    .step(1)
    .onFinishChange(generateGalaxy);
